...
function NewUser() {
    ...
    useEffect(() => {
        document.title='New Patient Registration';
    }, [])
    ...
    function handleSubmit(){
        ...
        let login={ email:email, password:password, type:type, name:name}
        DataService.createLogin(login);
        if(DataService.createPatient(patient)){
            history.push({
                pathname: '/',
    ...
    return (
        <div>
            <button id='newUserBack' onClick={navigateLogin}>Back</button>
